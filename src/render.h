...
void init_face(FT_Library library, FT_Face &face, std::string 
    fontpath="../fonts/GoNotoCurrent.ttf", unsigned int fontsize=16);
...
std::string render_text(FT_Face &face, std::string text, unsigned char *array, 
    ...
    bool fix_spacing=true, bool no_partial=false, bool no_margin=false);
...
std::string render_text_onto_array(std::string text, unsigned char *array, 
    ...
    bool fixed_width=true, bool fix_spacing=true, bool no_partial=false, bool no_margin=false,
    std::string fontpath="fonts/GoNotoCurrent.ttf");
...
void only_render_text_onto_array_unicode(std::string text, 
    ...
    bool no_partial=false, bool no_margin=false, 
    std::string fontpath="fonts/GoNotoCurrent.ttf");
